...
public class AdminManagementView extends JPanel {
    ...
    private void createAdminList() {
        ...
        adminTable.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (column == 3) return createActionPanel();
        ...
        addNewButton.addActionListener(e -> openAddAdminDialog());
    ...
    private void openAddAdminDialog() {
        ...
        int result = JOptionPane.showConfirmDialog(null, panel, "Add New Admin",
    ...
    class ButtonEditor extends AbstractCellEditor implements javax.swing.table.TableCellEditor {
        ...
        public ButtonEditor() {
            ...
            deleteButton.addActionListener(e -> {
                ...
                if (row != -1) {
                    int confirm = JOptionPane.showConfirmDialog(null, "Delete this admin?", "Confirm", JOptionPane.YES_NO_OPTION);
